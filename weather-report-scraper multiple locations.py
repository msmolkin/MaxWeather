...
# TODO: Update the script to include New York City (NYC) in the list of locations to process.
# Add the following entry to the 'locations' list in the main() function:
